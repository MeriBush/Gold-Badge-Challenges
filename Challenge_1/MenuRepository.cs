...
namespace Challenge_1
{
    ...
    {
        //--2-- Dear human, here I am in MenuRepository to learn learn about menuRepo's mystical powers.

        //--3--Looks like menuRepo contains a list named "drinks." This list is full of the objects from the Menu class. It's very private though, and is shy about communicating outside of
        ...
        //--4--Oooo, here are some of menuRepo's mystical powers you told me about! Looks like it can count the number of Menu objects in the "drinks" list. That's cool!
        ...
        //--5-- Looks like menuRepo can also add objects from the menu (we'll just generalize and call each one "drink") to the list called "drinks!" That's handy.
        public void AddDrinkToMenu(Menu drink)
        {
            drinks.Add(drink);
        }

        //--6-- And of course, menuRepo can also remove an object of the Menu class (aka, a drink) from the "drinks" list. This looks a little more complicated, though...
        public void RemoveDrinkFromMenu(string name)
        {
            //--7-- How does menuRepo know which drink you, the user, wants to remove? Well, it uses a string that you enter (we'll call this string "name" and an integer that you've named
        ...
        //See all items on the Menu
        //--8-- Okay, so you know how I said that the list called "drinks" would need a more extroverted friend to help it communicate outside of this file? Well, I think that this is its friend!
        ...
        //public void printList(List<Menu> theList)
        //{
        //    foreach (Menu drink in theList)
        //    {
        //        Console.WriteLine(drink);
        //    }
        //}

        //--9-- So, it looks like another mystical power of menuRepo is to print to the console. This mystical power (aka "method" or "function" is named "printDrinks()"
